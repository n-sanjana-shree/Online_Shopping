...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2023 at 07:35 PM
...
(21, 'Tina', 9999999999, 'ks layout', 'company', 'there', 1111111111, '1111111111', 'tina@gmail.com', 'tina', 'isPB/f8GowU='),
(23, 'Ria', 9898989898, 'ks layout', 'company', 'there', 1111111111, '1111111111', 'ria@gmail.com', 'ria', 'password'),
(24, 'Rita', 9000000000, '#574/75\r\n69TH CROSS 1ST STAGE KUMARASWAMY LAYOUT', 'company', 'there', 12345678, '1111111111', 'rita@gmail.com', 'Rita', 'rit');
...
(93, 'N SANJANA SHREE', 9999999999, 'Ks layout', 'KARNATAKA', 'Belgaum', '1111111111', 1111111111, 'isPB/f8GowU='),
(94, 'N SANJANA SHREE', 9999999999, 'ks layout', 'KARNATAKA', 'Belgaum', '1111111111', 1111111111, 'isPB/f8GowU='),
(95, 'Sanjana', 9999999999, 'ks layout', 'LAKSHADWEEP', 'Lakshadweep', '1111111111', 1111111111, 'isPB/f8GowU='),
(96, 'Sanjana Shree', 9999999999, 'ks layout', 'MAHARASHTRA', 'Nandurbar *', '1111111111', 1111111111, 'password'),
(97, 'Tina', 9090909090, 'ks layout', 'LAKSHADWEEP', 'Lakshadweep', '1111111111', 1111111111, 'tinapass'),
(98, 'nagashree', 876786896, '#574/7569TH CROSS 1ST STAGE KUMARASWAMY LAYOUT     ', '0', 'Select District', '123455', 12345678, 'nag'),
(99, 'Supriya', 9999999999, '#574/7569TH CROSS 1ST STAGE KUMARASWAMY LAYOUT  ', 'GOA', 'North Goa', '1111111111', 0, 'sup'),
(100, 'Titu', 9292929292, 'ddd', 'LAKSHADWEEP', 'Lakshadweep', '1111111111', 1111111111, 'titu');
...
(61, 24, 1, 'fam', 'Farmer', 8169193101, 101, 'paytm', 9819104641),
(62, 38, 1, 'fam', 'Farmer', 8169193124, 100, 'paytm', 9819104641),
(63, 23, 1, 'fam', 'Farmer', 8169193101, 56, 'cod', 9819104641),
(64, 39, 1, 'ks layout', 'Farmer', 9999999999, 100, 'paytm', 9898989898),
(65, 17, 1, 'ks layout', 'Farmer', 8169193102, 30, 'cod', 9898989898),
(66, 17, 1, '#574/75\r\n69TH CROSS 1ST STAGE KUMARASWAMY LAYOUT', 'Farmer', 8169193102, 30, 'paytm', 9000000000);
...
(38, 27, 'apple', '3', 'apple', '2020-12-31', 'apple.jpg', 1, 100, 'apple', 'best apple', 'yes'),
(39, 93, 'apple', '3', 'apple', '2020-12-30', 'apple.jpg', 1, 100, 'apple', 'best apple', 'yes'),
(40, 99, 'apple', '3', 'apple', '2020-12-31', 'apple.jpg', 1, 100, 'kkk', 'best apple', 'yes'),
(41, 99, 'mango', '3', 'mango', '2021-01-02', 'mango.jpg', 1, 100, 'jjj', 'best mango', 'yes');
...
--
ALTER TABLE `farmerregistration`
  MODIFY `farmer_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
