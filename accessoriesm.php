<?php
    ...
    $query1="select producti from malea";
    $result1=mysqli_query($con,$query1);
    $query2="select productn from malea";
    $result2=mysqli_query($con,$query2);
     $query3="select description from malea";
    $result3=mysqli_query($con,$query3);
     $query4="select categoryi from malea";
    $result4=mysqli_query($con,$query4);
     $query5="select departmenti from malea";
...
<style>
body {
  background-image: url('https://www.123freevectors.com/wp-content/original/108287-red-and-white-wave.jpg');
  ...
  background-size: cover;
    ...
    <body>
	<h1 align="center"><b><b><u>ACCESSORIES FOR MALES</u></b></b></h1><br><br><br><br><br><a href="oderingall.php">CLICK HERE FOR FINAL ORDER</a>
        <div class="row">
           <div class="column" align="center">
               
                        <img class="img-responsive" src="https://cdn.hiconsumption.com/wp-content/uploads/2018/04/Best-Style-Accessories-For-Men.jpg" alt="" align="middle" style="width:400px;height:400px;>
                        <div class="caption">
				...
				<h3><label>PRODUCT ID:</label><input type="name" value="<?php
                          ...
                          echo $rows['producti'];
                        ?>" readonly required="" id="Product_id" name="producti" /></h3>
			</div>
                        <div align="center">
				...
				<h3><label>PRODUCT NAME:</label><input type="name" value="<?php
                          ...
                          echo $rows['productn'];
                        ?>" readonly required="" id="Name" name="name" /></h3>
			</div>
                       <div align="center">
				...
				<h3><label>DESCRIPTION:</label><input type="name" value="<?php
                        ...
                        <h3><label>CATEGORY ID:</label><input type="name" value="<?php
                          ...
                          echo $rows['categoryi'];
                        ?>" readonly required="" id="Category_id" name="categoryid" /></h3>
                         </div>
                         <div align="center">
                        ...
                        ?>" readonly required="" id="Department_id" name="departmentid" /></h3>
                         </div>
                         <form action="" method="get" id="form1">
            ...
            <div class="column" align="center">
                        ...
                        <br><br><br><br><img class="img-responsive" src="https://cdn.hiconsumption.com/wp-content/uploads/2018/04/Best-Style-Accessories-For-Men.jpg" alt="" align="middle" style="width:400px;height:400px;>
                        <div class="caption">
                         <br><br><div class="panel panel-success" style="width: 500px" >
                           <div class="panel-body" style="width: 500px">
                         <form action="" method="get" id="form1">
