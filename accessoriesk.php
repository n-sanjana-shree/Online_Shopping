<?php
    ...
    $query1="select producti from kidsa";
    $result1=mysqli_query($con,$query1);
    $query2="select productn from kidsa";
    $result2=mysqli_query($con,$query2);
     $query3="select description from kidsa";
    $result3=mysqli_query($con,$query3);
     $query4="select categoryi from kidsa";
    $result4=mysqli_query($con,$query4);
     $query5="select departmenti from kidsa";
...
<style>
body {
  background-image: url('http://getwallpapers.com/wallpaper/full/7/6/d/183682.jpg');
  ...
  background-size: cover;
    ...
    <body>
	<h1 align="center"><b><b><u>ACCESSORIES FOR KIDS</u></b></b></h1><br><br><br><br><br><a href="oderingall.php">CLICK HERE FOR FINAL ORDER</a>
        <div class="row">
           <div class="column" align="center">
               
                        <img class="img-responsive" src="http://gyaankibaat.lookchup.com/wp-content/uploads/2019/07/Best-Kids-Accessories-Hacks-1024x573.jpg" alt="" align="middle" style="width:400px;height:400px;>
                        <div class="caption">
            ...
            <div class="column" align="center">
                        ...
                        <br><br><br><br><img class="img-responsive" src="http://gyaankibaat.lookchup.com/wp-content/uploads/2019/07/Best-Kids-Accessories-Hacks-1024x573.jpg" alt="" align="middle" style="width:400px;height:400px;>
                        <div class="caption">
                        <br><br><div class="panel panel-success" style="width: 500px" >
                         <div class="panel-body" style="width: 500px">
                         <form action="" method="get" id="form1">
