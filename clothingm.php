<?php
 session_start();
    ...
    $query1="select producti from malec";
    $result1=mysqli_query($con,$query1);
    $query2="select productn from malec";
    $result2=mysqli_query($con,$query2);
     $query3="select description from malec";
    $result3=mysqli_query($con,$query3);
     $query4="select categoryi from malec";
    $result4=mysqli_query($con,$query4);
     $query5="select departmenti from malec";
...
<style>
body {
  background-image: url('https://backgrounddownload.com/wp-content/uploads/2018/09/plain-red-and-white-background-6.jpg');
  ...
  background-size: cover;
    ...
    <body>
	<h1 align="center"><b><b><u>CLOTHING FOR MALES</u></b></b></h1><br><br><br><br><br><a href="orderingall.php">CLICK HERE FOR FINAL ORDER</a>
        <div class="row">
           <div class="column" align="center">
               
                        <img class="img-responsive" src="http://www.ofrapp.com/mobileapp/offers/44892fashion1.jpg" alt="" align="middle" style="width:400px;height:400px;>
                        <div class="caption">
            ...
            <div class="column" align="center">
                        ...
                        <br><br><br><br><img class="img-responsive" src="http://www.ofrapp.com/mobileapp/offers/44892fashion1.jpg" alt="" align="middle" style="width:400px;height:400px;>
                        <div class="caption">
                         <br><br><div class="panel panel-success" style="width: 500px" >
                           <div class="panel-body" style="width: 500px">
                         <form action="" method="get" id="form1">
